...
>
  ...
  >
    ...
    <div class="el-upload__tip text-center" slot="tip">
      <el-checkbox v-model="importDialog.updateSupport" />是否更新已存在的运输车数据
      <br />
...
import { importTransport } from "@/api/device/transport"
// 新增：导入token工具（用于请求头）
...
const importDialog = reactive({
  ...
  url: import.meta.env.VITE_APP_BASE_API + "/device/transport/importData" // 导入接口地址
})
